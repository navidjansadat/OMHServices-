...
app.post('/api/services', requireAuth, async (req, res) => {
    try {
        const {
            ...
            price, discount, unit, image, icon, delivery_time,
            guarantee, is_active, is_featured, order
        } = req.body;
...
app.get('/api/admin/stats', requireAuth, async (req, res) => {
    try {
        const [categories, subcategories, services, reviews, pendingReviews] = await Promise.all([
